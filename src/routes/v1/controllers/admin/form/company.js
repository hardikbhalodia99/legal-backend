...
const { checkClientBelongsToOrganization,getEmployeeByAppwriteId } = require("../../../../../utils/sql/legal/index.js");
...
async function uploadDocuments(req,res){
  try {
    ...
    const { image_base64,upload_location, image_slug,content_type,user_id,client_id } = req.body;
